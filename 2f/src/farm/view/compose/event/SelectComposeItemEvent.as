package farm.view.compose.event
{
   ...
   public class SelectComposeItemEvent extends Event
   {
      ...
      public function SelectComposeItemEvent(param1:String, param2:Object = null, param3:Boolean = false, param4:Boolean = false, param5:Boolean = false){super(null,null,null);}
   }
}
