package bagAndInfo.amulet{   import bagAndInfo.BagAndInfoManager;   import bagAndInfo.amulet.vo.EquipAmuletActivateGradeVo;   import bagAndInfo.amulet.vo.EquipAmuletPhaseVo;   import bagAndInfo.amulet.vo.EquipAmuletVo;   import com.pickgliss.ui.ComponentFactory;   import com.pickgliss.ui.LayerManager;   import com.pickgliss.ui.controls.Frame;   import com.pickgliss.utils.ObjectUtils;   import ddt.CoreManager;   import road7th.data.DictionaryData;      public class EquipAmuletManager extends CoreManager   {            private static var _instance:EquipAmuletManager;                   private var _infoData:DictionaryData;            private var _activateGradeData:DictionaryData;            private var _phaseData:DictionaryData;            public var buyStiveNum:int;            public var lockNum:int;            private var _mainFrame:Frame;            public function EquipAmuletManager() { super(); }
      ...
            public function getAmuletVo(grade:int) : EquipAmuletVo { return null; }
            public function getAmuletPhaseVo(phase:int) : EquipAmuletPhaseVo { return null; }
            public function getAmuletPhaseVoByGrade(grade:int) : EquipAmuletPhaseVo { return null; }
            public function getAmuletActivateGradeVo(count:int) : EquipAmuletActivateGradeVo { return null; }
            public function getAmuletActivateNeedCount(count:int) : int { return 0; }
            public function getAmuletHpByGrade(grade:int) : int { return 0; }
            public function getAmuletPhaseByGrade(grade:int) : int { return 0; }
            public function getAmuletPhaseGradeByCount(count:int) : int { return 0; }
   }}