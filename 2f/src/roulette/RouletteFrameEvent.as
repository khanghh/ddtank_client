package roulette
{
   ...
   public class RouletteFrameEvent extends Event
   {
      ...
      public function RouletteFrameEvent(param1:String, param2:String = null, param3:Array = null, param4:Boolean = false, param5:Boolean = false){super(null);}
      
      public function get reward() : String{return null;}
      
      public function get arr() : Array{return null;}
   }
}
