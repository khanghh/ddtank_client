package devilTurn.view.mornui
{
   ...
   public class DevilTurnMainViewUI extends View
   {
      ...
      public function DevilTurnMainViewUI()
      {
         super();
      }
      ...
      {
         viewClassMap["devilTurn.view.DevilTurnMallView"] = DevilTurnMallView;
         viewClassMap["devilTurn.view.DevilTurnTreasureView"] = DevilTurnTreasureView;
         super.createChildren();
         loadUI("DevilTurnMainView.xml");
      }
   }
}
