package sevenDouble.view
{
   ...
   public class SevenDoubleRankCell extends Sprite implements Disposeable
   {
      ...
      public function SevenDoubleRankCell(index:int)
      {
         ...
         _rateTxt.text = SevenDoubleControl.instance.rankAddInfo[index] + "%";
         ...
         var tmpItemInfo:ItemTemplateInfo = ItemManager.Instance.getTemplateById(SevenDoubleControl.instance.sprintAwardInfo[index]);
