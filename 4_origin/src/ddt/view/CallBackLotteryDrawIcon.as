package ddt.view
{
   ...
   public class CallBackLotteryDrawIcon extends Sprite implements Disposeable
   {
      ...
      public function CallBackLotteryDrawIcon()
      {
         super();
         initView();
         initEvent();
      ...
      {
         _activityIcon = ComponentFactory.Instance.creat("asset.hall.callBackLotteryDrawIcon1");
