package church.player
{
   ...
   public class ChurchPlayerBase extends SceneCharacterPlayerBase
   {
      ...
      private function showDefaultCharacter() : void
      {
         ...
         _defaultSceneCharacterSetNatural.push(new SceneCharacterItem("NaturalFrontHead","NaturalFrontAction",actionBmp,1,1,playerWitdh,playerHeight,1));
      ...
      {
         var _sceneCharacterLoaderPath:* = null;
         if(ChurchManager.instance.isAdmin(_playerInfo))
         {
