package bones.display
{
   ...
   public class BoneMovieFlash extends Sprite implements IBoneMovie, Disposeable
   {
      ...
      private function clearArmature() : void
      {
         ...
         if(_deafultImage && _deafultImage.parent)
         {
            _deafultImage.parent.removeChild(_deafultImage);
         }
         _deafultImage = null;
      }
      ...
      private function __onLoaderComplete(param1:BonesLoaderEvent) : void
      {
         if(_styleName == param1.vo.styleName)
         {
            ...
            setArmature(BoneMovieFactory.instance.getArmature(_styleName,BoneMovieFactory.instance.flashFactory));
