package escort.view
{
   ...
   public class EscortExitBtn extends Sprite implements Disposeable
   {
      ...
      {
         _bg = ComponentFactory.Instance.creatBitmap("asset.escort.returnBtn.bg");
         _moveOutBtn = ComponentFactory.Instance.creatComponentByStylename("escort.moveOutBtn");
         _moveInBtn = ComponentFactory.Instance.creatComponentByStylename("escort.moveInBtn");
         _returnBtn = ComponentFactory.Instance.creatComponentByStylename("escort.returnBtn");
         addChild(_bg);
      ...
      {
         SoundManager.instance.play("008");
         var confirmFrame:BaseAlerFrame = AlertManager.Instance.simpleAlert(LanguageMgr.GetTranslation("AlertDialog.Info"),LanguageMgr.GetTranslation("escort.leaveGamePromptTxt"),LanguageMgr.GetTranslation("ok"),LanguageMgr.GetTranslation("cancel"),true,true,true,1);
