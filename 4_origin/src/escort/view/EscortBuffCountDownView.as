package escort.view
{
   ...
   public class EscortBuffCountDownView extends Sprite implements Disposeable
   {
      ...
      public function EscortBuffCountDownView(param1:Date, param2:int, param3:int)
      {
         super();
         if(param2 == 3)
         {
         ...
         _endTime = param1;
         _type = param2;
         _bg = ComponentFactory.Instance.creatBitmap("asset.escort.buffCountDownBg");
         _titleTxt = ComponentFactory.Instance.creatComponentByStylename("escort.game.buffTitleTxt");
         _titleTxt.text = LanguageMgr.GetTranslation("escort.game.buffTitleTxt" + _type);
         _titleTxt.textColor = colorList[_type - 1];
         _countDownTxt = ComponentFactory.Instance.creatComponentByStylename("escort.game.buffCountDownTxt");
         addChild(_bg);
         addChild(_titleTxt);
