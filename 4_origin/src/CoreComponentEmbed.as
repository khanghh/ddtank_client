package
{
   ...
   public class CoreComponentEmbed
   {
      ...
      {
         super();
         RedPackageGainRecordListCell;
         RedPackageHelpCell;
         RedPackageGainListCell;
         CampBattleView;
         GameControl;
         FloatParadeMainView;
         DDTKingFloatMainView;
         DDTKingFloatBuyConfirmView;
         DragonBoatShopFrame;
         MagPieBridgeView;
         NewPetSkillPanel;
         FarmFriendListItem;
         ...
         StrengthTips;
         EmbedStoneTip;
         FusionNewUnitListCell;
         AcademyController;
         BagAuctionFrame;
         AuctionDimCell;
         AuctionHouseController;
         WeddingRoomGuestListItemView;
         CivilController;
         CollectionTaskMainView;
         WorldBossAwardController;
         WorldBossFightRoomState;
         ChurchRoomController;
         ChurchRoomListController;
         ChurchInvitePlayerItem;
         TofflistController;
         TrainerGameView;
         KeepPayTip;
         MemberItem;
         ConsortiaLevelTip;
         BadgeTip;
         FilterFrameTextWithTips;
         ConsortionControl;
         ConsortiaBattleMainView;
         HorseSkillCellTip;
         LittleHall;
         LittleGame;
         MagicStoneMainView;
         ...
         SingleBattleMatchState;
         CampBattleLoadingState;
         FightLibState;
         AwardCell;
         WebSpeedTip;
         PlayerThumbnailTip;
         ...
         TotemActProConfirmFrame;
         FeedbackSubmitFrame;
         FeedbackReplyFrame;
         AvatarCollectionUnitListCell;
         AvatarCollectionItemTip;
         AvatarCollectionDelayConfirmFrame;
         PlayerBeadInfoView;
         BeadInfoView;
         CardBagListItem;
         ConsortionWeekRewardItem;
         BattleGroundScrollPanelCell;
         ConsBatScoreViewListCell;
         PetBenchBagTip;
         PetAtlasBagFrame;
         PetAtlasTips;
         PyramidSystem;
         ...
         GuardCoreView;
         GuardCoreBuffTips;
         GodCardRaiseExchangeLeftCell;
         BoguAdventureStateView;
         MagicStoneConfirmView;
         TofflistTitleInfoTip;
         MoneyTreeRmbConfirmAlert;
         HotSpringRoomListManager;
         HotSpringRoomManager;
         DemonChiYouSence;
         CardAchievementItem;
         DemonChiYouSence;
         GameView3D;
         GameViewScene;
         DemonChiYouSence;
         ConsortiaDomainScene;
         ConsortionUpGradeFrame;
         CardAchievementItem;
         SignActivityFrame;
         DDTKingGradeFrame;
         DDTKingGradeTips;
         ...
         LittileGameFrame;
         IndianaMainView;
         EquipAmuletMainFrame;
         EquipAmuletActivateGradeTips;
         EquipAmuletActivatePhaseTips;
         SimpleGameRankFrame;
         SimpleGameRankItem;
         CubeGameStateView;
         CubeGameSceneView;
