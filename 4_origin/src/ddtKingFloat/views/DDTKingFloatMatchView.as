package ddtKingFloat.views
{
   ...
   public class DDTKingFloatMatchView extends Frame
   {
      ...
      public function DDTKingFloatMatchView()
      {
         super();
         initView();
         initEvent();
      ...
      private function initView() : void
      {
         ...
         _bg = ComponentFactory.Instance.creatBitmap("ddtKing.matchView.bg");
         _typeTextIcon = ComponentFactory.Instance.creatBitmap("ddtKing.matchView.txtIcon");
         _tipTxtIcon = ComponentFactory.Instance.creatBitmap("ddtKing.matchView.tipTxtIcon");
         _carImg = ComponentFactory.Instance.creatBitmap("ddtKing.matchView.car" + DDTKingFloatManager.instance.carStatus);
         _leftTxt = ComponentFactory.Instance.creatComponentByStylename("ddtKing.race.matchViewTipTxt");
         _leftTxt.text = LanguageMgr.GetTranslation("escort.frame.matchViewTipTxt");
         _rightTxt = ComponentFactory.Instance.creatComponentByStylename("ddtKing.race.matchView.rightTxt");
         _rightTxt.text = LanguageMgr.GetTranslation("ddtKing.match.description");
         _timeTxt = ComponentFactory.Instance.creatComponentByStylename("ddtKing.race.matchView.timeTxt");
         _timeTxt.text = "0" + _countDown;
         _cancelBtn = ComponentFactory.Instance.creatComponentByStylename("ddtKing.matchView.cancelBtn");
         addToContent(_bg);
      ...
      private function removeEvent() : void
      {
         ...
         DDTKingFloatManager.instance.removeEventListener("floatParadeCancelGame",cancelGameHandler);
      }
