package ddtKingFloat.views
{
   ...
   public class DDTKingFloatThreeBtnView extends Sprite implements Disposeable
   {
      ...
      private function initView() : void
      {
         ...
         while(_loc2_ < 4)
         {
            _loc1_ = ComponentFactory.Instance.creat("ddtKing.freeTipMc") as MovieClip;
            _loc1_.x = -36;
      ...
      {
         var _loc3_:int = 0;
         var _loc2_:Array = DDTKingFloatManager.instance.itemFreeCountList;
         _loc3_ = 0;
         while(_loc3_ < 4)
         {
            if(_loc2_[_loc3_] > 0)
      ...
      {
         var _loc2_:DDTKingFloatEvent = new DDTKingFloatEvent("floatParadeLeapPromptShowHide");
         _loc2_.data = {"isShow":false};
         DDTKingFloatManager.instance.dispatchEvent(_loc2_);
      }
         ...
         if(_leapBtn !== _loc4_)
         {
            if(_invisibilityBtn !== _loc4_)
            {
               if(_cleanBtn !== _loc4_)
               {
                  ...
                  {
                     _recordClickTag = 3;
                     _loc3_ = ComponentFactory.Instance.creatComponentByStylename("ddtKing.missileFrame.frame");
      ...
      public function useSkill() : void
      {
         ...
         var _loc2_:Object = DDTKingFloatManager.instance.getBuyRecordStatus(_recordClickTag + 2);
         var _loc1_:int = DDTKingFloatManager.instance.dataInfo.useSkillNeedMoney[_recordClickTag];
      ...
      private function useSkillConfirm(param1:FrameEvent) : void
      {
         ...
         {
            _loc2_ = DDTKingFloatManager.instance.dataInfo.useSkillNeedMoney[_recordClickTag];
            ...
            {
               _loc4_ = DDTKingFloatManager.instance.getBuyRecordStatus(_recordClickTag + 2);
      ...
      private function sendUseSkillSocket(param1:int, param2:Boolean, param3:Boolean, param4:int = 0, param5:int = -1) : void
      {
         ...
         else
         {
            ...
            _loc6_.push(param4);
            _loc6_.push(param5);
            DDTKingFloatManager.instance.missileArgArr = _loc6_;
