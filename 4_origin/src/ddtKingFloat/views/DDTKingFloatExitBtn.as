package ddtKingFloat.views
{
   ...
   public class DDTKingFloatExitBtn extends Sprite implements Disposeable
   {
      ...
      public function DDTKingFloatExitBtn()
      {
         super();
         this.x = 909;
         this.y = 513;
      ...
      {
         _bg = ComponentFactory.Instance.creatBitmap("ddtKing.returnBtn.bg");
         _moveOutBtn = ComponentFactory.Instance.creatComponentByStylename("ddtKing.moveOutBtn");
         _moveInBtn = ComponentFactory.Instance.creatComponentByStylename("ddtKing.moveInBtn");
         _returnBtn = ComponentFactory.Instance.creatComponentByStylename("ddtKing.returnBtn");
         addChild(_bg);
