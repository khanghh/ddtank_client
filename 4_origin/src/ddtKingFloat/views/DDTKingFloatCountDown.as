package ddtKingFloat.views
{
   ...
   public class DDTKingFloatCountDown extends Sprite implements Disposeable
   {
      ...
      public function DDTKingFloatCountDown()
      {
         super();
         this.x = 260;
         initView();
      ...
      private function initView() : void
      {
         ...
         _recordTxt = LanguageMgr.GetTranslation("ddtKing.frame.countDownViewTxt");
