package ddtKingFloat.components
{
   ...
   public class DDTKingFloatNameCell extends Sprite implements Disposeable
   {
      ...
      public function DDTKingFloatNameCell(param1:int)
      {
         super();
         _index = param1;
         initView();
      ...
      {
         _selectedLight = ComponentFactory.Instance.creat("ddtKing.missile.selectedLight");
         ...
         addChild(_sprite);
         _nameTxt = ComponentFactory.Instance.creatComponentByStylename("ddtKing.missileFrame.nameTxt");
         _nameTxt.text = "小妹也带刀";
         addChild(_nameTxt);
