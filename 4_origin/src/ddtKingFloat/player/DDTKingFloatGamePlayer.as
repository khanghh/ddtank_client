package ddtKingFloat.player
{
   ...
   public class DDTKingFloatGamePlayer extends Sprite implements Disposeable
   {
      ...
      public function DDTKingFloatGamePlayer(playerInfo:DDTKingFloatPlayerInfo)
      {
         var t:int = 0;
      ...
      public function set destinationX(value:Number) : void
      {
         ...
         {
            tmpSpeed = tmpSpeed * DDTKingFloatManager.instance.accelerateRate / 100;
         }
         if(_playerInfo.deceleEndTime.getTime() > TimeManager.Instance.Now().getTime())
         {
            tmpSpeed = tmpSpeed * DDTKingFloatManager.instance.decelerateRate / 100;
         }
      ...
      {
         var loader:BaseLoader = LoadResourceManager.Instance.createLoader(DDTKingFloatManager.instance.getPlayerResUrl(_playerInfo.isSelf,_playerInfo.carType),4);
      ...
      private function showOrHideLeapArrow(event:DDTKingFloatEvent) : void
      {
      ...
      public function refreshBuffCountDown() : void
      {
         ...
         if(_playerInfo.deceleEndTime.getTime() > TimeManager.Instance.Now().getTime())
         {
            ...
            {
               tmpBuffCDV = new DDTKingFloatBuffCountDown(_playerInfo.deceleEndTime,2,_buffCountDownList.length);
         ...
         {
            tmp2 = _buffCountDownList["2"] as DDTKingFloatBuffCountDown;
         ...
         if(_playerInfo.acceleEndTime.getTime() > TimeManager.Instance.Now().getTime())
         {
            ...
            {
               tmpBuffCDV = new DDTKingFloatBuffCountDown(_playerInfo.acceleEndTime,1,_buffCountDownList.length);
               tmpBuffCDV.addEventListener("EscortBuffCountDownEnd",buffCountDownEnd,false,0,true);
               addChild(tmpBuffCDV);
         ...
         {
            tmp3 = _buffCountDownList["1"] as DDTKingFloatBuffCountDown;
         ...
         if(_playerInfo.invisiEndTime.getTime() - TimeManager.Instance.Now().getTime() > 0)
         {
            ...
            {
               tmpBuffCDV = new DDTKingFloatBuffCountDown(_playerInfo.invisiEndTime,3,_buffCountDownList.length);
               tmpBuffCDV.addEventListener("EscortBuffCountDownEnd",buffCountDownEnd,false,0,true);
               addChild(tmpBuffCDV);
         ...
         {
            tmp = _buffCountDownList["3"] as DDTKingFloatBuffCountDown;
         ...
         var __now:Date = TimeManager.Instance.Now();
         if(_playerInfo.missileEndTime.getTime() - __now.getTime() > 0)
         {
            if(_playerInfo.missileHitEndTime.getTime() - __now.getTime() > 0)
            {
            ...
            {
               tmpBuffCDV = new DDTKingFloatBuffCountDown(_playerInfo.missileEndTime,4,_buffCountDownList.length);
               tmpBuffCDV.addEventListener("EscortBuffCountDownEnd",buffCountDownEnd,false,0,true);
               addChild(tmpBuffCDV);
         ...
         {
            tmp4 = _buffCountDownList["4"] as DDTKingFloatBuffCountDown;
      ...
      {
         var tmp:DDTKingFloatBuffCountDown = event.target as DDTKingFloatBuffCountDown;
         tmp.removeEventListener("EscortBuffCountDownEnd",buffCountDownEnd);
         ObjectUtils.disposeObject(tmp);
         _buffCountDownList.remove(tmp.type);
         refreshBuffCountDown();
