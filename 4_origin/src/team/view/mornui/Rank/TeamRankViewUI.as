package team.view.mornui.Rank
{
   ...
   public class TeamRankViewUI extends View
   {
      ...
      public function TeamRankViewUI()
      {
         super();
      }
      ...
      {
         viewClassMap["team.view.rank.TeamRankItem"] = TeamRankItem;
         viewClassMap["team.view.rank.TeamRankLeftItem"] = TeamRankLeftItem;
         viewClassMap["team.view.rank.TeamRankRightView"] = TeamRankRightView;
         super.createChildren();
         loadUI("Rank/TeamRankView.xml");
      }
   }
}
