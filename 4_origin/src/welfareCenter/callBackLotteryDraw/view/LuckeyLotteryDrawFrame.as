package welfareCenter.callBackLotteryDraw.view
{
   ...
   public class LuckeyLotteryDrawFrame extends Frame
   {
      ...
      public function LuckeyLotteryDrawFrame()
      {
         super();
         initView();
         initEvent();
      ...
      private function initView() : void
      {
         ...
         _model = _manager.luckeyLotteryDrawModel;
         _nextCDTimeTf = UICreatShortcut.creatAndAdd("luckeylotterydraw.nextCDTimeTf",_container);
         _startDrawBtn = UICreatShortcut.creatAndAdd("luckeylotterydraw.startDrawBtn",_container);
      ...
      {
         _cardShowMC = ComponentFactory.Instance.creat("luckeylotterydraw.cardShow");
         PositionUtils.setPos(_cardShowMC,"luckeylotterydraw.cardShow.pos");
         addToContent(_cardShowMC);
      ...
      private function playCardShuffle() : void
      {
         ...
         _cardShuffleMC = ComponentFactory.Instance.creat("luckeylotterydraw.cardShuffle");
         PositionUtils.setPos(_cardShuffleMC,"luckeylotterydraw.cardShuffle.pos");
         addToContent(_cardShuffleMC);
      ...
      private function onBtnClick(evt:MouseEvent) : void
      {
         ...
         else
         {
            ...
            onCheckComplete = function():void
            {
               ...
               SocketManager.Instance.out.buyCallLotteryDrawGood(1,award["Index"],CheckMoneyUtils.instance.isBind);
            };
      ...
      {
         _manager.checkLuckeyActiveOpen();
         removeEvent();
         super.dispose();
