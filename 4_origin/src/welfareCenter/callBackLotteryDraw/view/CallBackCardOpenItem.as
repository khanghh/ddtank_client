package welfareCenter.callBackLotteryDraw.view
{
   ...
   public class CallBackCardOpenItem extends Sprite implements Disposeable
   {
      ...
      public function CallBackCardOpenItem(param1:int, param2:int, param3:int)
      {
         ...
         _border = ComponentFactory.Instance.creat("callbacklotterydraw.cardMouseOverBorder");
         _border.x = 4;
         _border.y = 12;
         addChild(_border);
      ...
      private function onCardOpenMCMouseHandler(param1:MouseEvent) : void
      {
         ...
         if(_hasFlipOver == false)
         {
            ...
            if(eventType == "click")
            {
               ...
               SocketManager.Instance.out.buyCallLotteryDrawGood(0,_award["Index"],false);
            }
         ...
         else if(eventType == "click")
         {
            ...
            if(target == _buyBtn)
            {
               ...
               {
                  LayerManager.Instance.addToLayer(_maskSp,3,true,2);
                  SocketManager.Instance.out.buyCallLotteryDrawGood(0,_award["Index"],CheckMoneyUtils.instance.isBind);
               };
               SoundManager.instance.playButtonSound();
