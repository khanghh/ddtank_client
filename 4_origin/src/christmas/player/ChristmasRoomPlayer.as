   ...
   public class ChristmasRoomPlayer extends ChristmasRoomPlayerBase
   {
      ...
      private function initialize() : void
      {
         ...
         if(_isShowName)
         {
            if(!_lblName)
            {
               _lblName = ComponentFactory.Instance.creat("asset.christmasroom.characterPlayerNameAsset");
            }
            ...
            {
               _vipIcon = ComponentFactory.Instance.creatCustomObject("asset.christmas.VipIcon");
         ...
         _face.y = -90;
         addChild(_face);
         _fightIcon = ComponentFactory.Instance.creat("asset.christmas.fighting");
         addChild(_fightIcon);
         _fightIcon.visible = false;
         _fightIcon.gotoAndStop(1);
         _tombstone = ComponentFactory.Instance.creat("asset.christmas.tombstone");
         addChild(_tombstone);
      ...
      private function characterDirectionChange(param1:SceneCharacterEvent) : void
      {
         ...
         else
         {
            ...
            if(isReadyFight)
            {
               dispatchEvent(new ChristmasRoomEvent("readyFight"));
            }
         }
      }
