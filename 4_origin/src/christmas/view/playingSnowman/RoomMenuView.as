package christmas.view.playingSnowman
{
   ...
   public class RoomMenuView extends Sprite implements Disposeable
   {
      ...
      {
         _BG = ComponentFactory.Instance.creatBitmap("asset.christmasRoom.menuBG");
         addChild(_BG);
         _closeBtn = ComponentFactory.Instance.creatComponentByStylename("asset.christmasRoom.switchBtn");
         addChild(_closeBtn);
         _switchIMG = ComponentFactory.Instance.creatComponentByStylename("asset.christmasRoom.switchIMG");
         _switchIMG.setFrame(1);
         _closeBtn.addChild(_switchIMG);
         _returnBtn = ComponentFactory.Instance.creatComponentByStylename("asset.christmasRoom.returnBtn");
         addChild(_returnBtn);
         setEvent();
      }
      ...
      private function backRoomList(param1:MouseEvent) : void
      {
         ...
         var _loc2_:BaseAlerFrame = AlertManager.Instance.simpleAlert(LanguageMgr.GetTranslation("AlertDialog.Info"),LanguageMgr.GetTranslation("christmas.room.leaveroom"),LanguageMgr.GetTranslation("ok"),LanguageMgr.GetTranslation("cancel"),false,false,false,2);
