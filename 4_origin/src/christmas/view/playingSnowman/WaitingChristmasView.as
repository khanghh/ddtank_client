package christmas.view.playingSnowman
{
   ...
   public class WaitingChristmasView extends Component
   {
      ...
      private function initView() : void
      {
         ...
         _loadingText = ComponentFactory.Instance.creatComponentByStylename("christmas.WaitingView.loadingText");
         _loadingText.text = _loadingArr[0];
         _timeText = ComponentFactory.Instance.creatComponentByStylename("christmas.WaitingView.timeText");
