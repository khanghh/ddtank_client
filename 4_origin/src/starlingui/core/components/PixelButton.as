package starlingui.core.components
{
   ...
   public class PixelButton extends DisplayObjectContainer
   {
      ...
      public function PixelButton(upState:Texture, text:String = "", downState:Texture = null, overState:Texture = null, disabledState:Texture = null, bitmapData:BitmapData = null)
      {
         super();
         if(upState == null)
         {
         ...
         mState = "up";
         mBody = new PixelImage(upState,bitmapData);
      ...
      private function onTouch(event:TouchEvent) : void
      {
         ...
         else if(touch.phase == "ended" && mState == "down")
         {
            ...
            if(!touch.cancelled)
            {
               dispatchEventWith("triggered",true,touch);
            }
         }
      }
