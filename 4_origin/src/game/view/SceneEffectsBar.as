package game.view
{
   ...
   public class SceneEffectsBar extends Sprite implements Disposeable
   {
      ...
      public function SceneEffectsBar(param1:MapView)
      {
         super();
         _map = param1;
         initView();
      ...
      private function addSceneEffect(param1:SceneEffectObj, param2:Boolean = false) : void
      {
         ...
         {
            var physicalObj:GameSceneEffect = _map.getSceneEffectPhysicalById(obj.id) as GameSceneEffect;
            if(physicalObj == null)
            {
            ...
            else
            {
               ...
               if(physicalObj.Id == SceneEffectObj.Bomb && obj.turn == 1)
               {
                  var gameSceneEffect:GameSceneEffect = physicalObj as GameSceneEffect;
      ...
      private function crateSceneEffect(param1:SceneEffectObj, param2:Boolean = false) : void
      {
         ...
         var _loc3_:GameSceneEffect = new GameSceneEffect(param1.id,_loc8_,_loc4_,5,50);
         _loc3_.x = _loc9_;
         _loc3_.y = _loc7_;
         if(_loc5_)
         {
