package demonChiYou.view
{
   ...
   public class WorldBossCutHpMC extends Sprite
   {
      ...
      private function init() : void
      {
         ...
         var _loc2_:Bitmap = ComponentFactory.Instance.creatBitmap("DemonChiYou.cutHP.valuNum10");
         ...
         {
            _loc1_ = ComponentFactory.Instance.creatBitmap("DemonChiYou.cutHP.valuNum" + _loc3_.charAt(_loc4_));
