package demonChiYou.view
{
   ...
   public class WorldBossRankingFram extends BaseAlerFrame
   {
      ...
      {
         _rankingPersons = [];
         titleText = LanguageMgr.GetTranslation("demonChiYou.ranking.title");
         titleBg = ComponentFactory.Instance.creatComponentByStylename("demonChiYou.RankingFrame.RankingTitleBg");
         addToContent(titleBg);
         titleLineBg = ComponentFactory.Instance.creatComponentByStylename("demonChiYou.RankingItem.bgLine");
         addToContent(titleLineBg);
         numTitle = ComponentFactory.Instance.creatComponentByStylename("demonChiYou.ranking.numTitle");
         numTitle.text = LanguageMgr.GetTranslation("worldboss.ranking.num");
         addToContent(numTitle);
         nameTitle = ComponentFactory.Instance.creatComponentByStylename("demonChiYou.ranking.nameTitle");
         nameTitle.text = LanguageMgr.GetTranslation("worldboss.ranking.name");
         addToContent(nameTitle);
         souceTitle = ComponentFactory.Instance.creatComponentByStylename("demonChiYou.ranking.souceTitle");
         souceTitle.text = LanguageMgr.GetTranslation("worldboss.ranking.socre");
         addToContent(souceTitle);
         _sureBtn = ComponentFactory.Instance.creat("demonChiYou.ranking.btn");
