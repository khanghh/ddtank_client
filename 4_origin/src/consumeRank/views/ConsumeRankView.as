package consumeRank.views
{
   ...
   public class ConsumeRankView extends Sprite implements IRightView
   {
      ...
      public function updateView() : void
      {
         ...
         _checkBg.tipData = LanguageMgr.GetTranslation("consumeRank.helpTxt",xmlData.remain2);
         var arr:Array = ConsumeRankManager.instance.rankList;
         var myConsume:int = ConsumeRankManager.instance.myConsume;
         _myRank = -1;
         ...
         if(_myRank >= 0)
         {
            ...
            else
            {
               ...
               remain = (arr[_myRank - 1] as ConsumeRankVo).consume - myConsume + 1;
               _rankLabelTxt.text = LanguageMgr.GetTranslation("consumeRank.rankLabel",remain);
            }
         ...
         else
         {
            ...
            _rankLabelTxt.text = LanguageMgr.GetTranslation("consumeRank.outOfRankLabel",myConsume,remain);
            if(ConsumeRankManager.instance.status == 2)
            {
               _rankLabelTxt.visible = true;
               _rankLabelTxt.textColor = 16711680;
