package cardSystem
{
   ...
   public class LaterEquipmentGrooveView extends Component
   {
      ...
      override protected function init() : void
      {
         ...
         _topName.text = LanguageMgr.GetTranslation("tank.view.card.GrooveText");
         _topName.textColor = 16777215;
         _GrooveLevel = ComponentFactory.Instance.creatComponentByStylename("CardsTipPanel.LevelTitle");
         _GrooveLevel.text = LanguageMgr.GetTranslation("tank.view.card.GrooveText1");
         PositionUtils.setPos(_GrooveLevel,"core.cardLevelBmpOne.pos1");
         _GrooveLevelDetail = ComponentFactory.Instance.creatComponentByStylename("cardSystem.level.big");
         PositionUtils.setPos(_GrooveLevelDetail,"core.grooveLevel.pos1");
