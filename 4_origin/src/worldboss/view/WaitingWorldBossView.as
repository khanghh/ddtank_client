package worldboss.view
{
   ...
   public class WaitingWorldBossView extends Component
   {
      ...
      private function initView() : void
      {
         ...
         _loadingText = ComponentFactory.Instance.creatComponentByStylename("worldBoss.WaitingView.loadingText");
         _loadingText.text = _loadingArr[0];
         _timeText = ComponentFactory.Instance.creatComponentByStylename("worldBoss.WaitingView.timeText");
