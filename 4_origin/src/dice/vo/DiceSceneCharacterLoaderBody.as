package dice.vo
{
   ...
   public class DiceSceneCharacterLoaderBody
   {
      ...
      public function DiceSceneCharacterLoaderBody(param1:PlayerInfo)
      {
         super();
         _playerInfo = param1;
      }
      ...
      {
         _loaders = new Vector.<DiceSceneCharacterLayer>();
         _recordStyle = _playerInfo.Style.split(",");
         _recordColor = _playerInfo.Colors.split(",");
         _loaders.push(new DiceSceneCharacterLayer(ItemManager.Instance.getTemplateById(int(_recordStyle[4].split("|")[0])),_recordColor[4],1,_playerInfo.Sex));
         _loaders.push(new DiceSceneCharacterLayer(ItemManager.Instance.getTemplateById(int(_recordStyle[4].split("|")[0])),_recordColor[4],2,_playerInfo.Sex));
      }
