package drgnBoat.views
{
   ...
   public class DrgnBoatBuffCountDown extends Sprite implements Disposeable
   {
      ...
      public function DrgnBoatBuffCountDown(param1:Date, param2:int, param3:int)
      {
         super();
         if(param2 == 3)
         {
         ...
         _endTime = param1;
         _type = param2;
         _bg = ComponentFactory.Instance.creatBitmap("drgnBoat.buffCountDownBg");
         _titleTxt = ComponentFactory.Instance.creatComponentByStylename("drgnBoat.game.buffTitleTxt");
         _titleTxt.text = LanguageMgr.GetTranslation("escort.game.buffTitleTxt" + _type);
         _titleTxt.textColor = colorList[_type - 1];
         _countDownTxt = ComponentFactory.Instance.creatComponentByStylename("drgnBoat.game.buffCountDownTxt");
         addChild(_bg);
         addChild(_titleTxt);
