package drgnBoat.views
{
   ...
   public class DrgnBoatFrameItemCell extends Sprite implements Disposeable
   {
      ...
      private function initView() : void
      {
         ...
         _awardInfoTxt1.text = LanguageMgr.GetTranslation("drgnBoat.race.awardInfo1",item.Name,_info.awardArr[0].count);
         ...
         ItemManager.fill(item);
         _awardInfoTxt2.text = LanguageMgr.GetTranslation("drgnBoat.race.awardInfo1",item.Name,_info.awardArr[1].count);
