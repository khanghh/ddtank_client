package drgnBoat.views
{
   ...
   public class DrgnBoatFrameItemCell extends Sprite implements Disposeable
   {
      ...
      public function DrgnBoatFrameItemCell(param1:int, param2:DrgnBoatCarInfo)
      {
         super();
         _index = param1;
         _info = param2;
         ...
         initEvent();
         refreshView(null);
         if(_dressUpBtn && DrgnBoatManager.instance.freeCount <= 0)
         {
      ...
      {
         _bg = ComponentFactory.Instance.creatBitmap("drgnBoat.cellBg" + _index);
         addChild(_bg);
         _awardBmp = ComponentFactory.Instance.creat("drgnBoat.award");
         addChild(_awardBmp);
         _currentBoat = ComponentFactory.Instance.creat("drgnBoat.currentBoat");
         addChild(_currentBoat);
         _currentBoat.visible = false;
         _awardInfoTxt1 = ComponentFactory.Instance.creatComponentByStylename("drgnBoat.race.awardTxt");
         var _loc1_:InventoryItemInfo = new InventoryItemInfo();
         _loc1_.TemplateID = _info.awardArr[0].templateId;
         ItemManager.fill(_loc1_);
         _awardInfoTxt1.text = LanguageMgr.GetTranslation("drgnBoat.race.awardInfo1",_loc1_.Name,_info.awardArr[0].count);
         addChild(_awardInfoTxt1);
         _awardInfoTxt2 = ComponentFactory.Instance.creatComponentByStylename("drgnBoat.race.awardTxt");
         PositionUtils.setPos(_awardInfoTxt2,"drgnBoat.race.awardTxtPos");
         _loc1_ = new InventoryItemInfo();
         _loc1_.TemplateID = _info.awardArr[1].templateId;
         ItemManager.fill(_loc1_);
         _awardInfoTxt2.text = LanguageMgr.GetTranslation("drgnBoat.race.awardInfo1",_loc1_.Name,_info.awardArr[1].count);
         addChild(_awardInfoTxt2);
         switch(int(_index))
         {
            case 0:
               _defaultTxt = ComponentFactory.Instance.creatComponentByStylename("drgnBoat.race.defaultTxt");
               _defaultTxt.text = LanguageMgr.GetTranslation("drgnBoat.race.noDress");
               addChild(_defaultTxt);
               break;
            case 1:
               _dressUpBtn = ComponentFactory.Instance.creatComponentByStylename("drgnBoat.race.dressUpTxtbtn");
               _dressUpBtn.text = LanguageMgr.GetTranslation("drgnBoat.race.normalDress");
               addChild(_dressUpBtn);
               break;
            case 2:
               _dressUpBtn = ComponentFactory.Instance.creatComponentByStylename("drgnBoat.race.dressUpTxtbtn");
               _dressUpBtn.text = LanguageMgr.GetTranslation("drgnBoat.race.luxuriousDress");
               addChild(_dressUpBtn);
         }
      }
      ...
      {
         if(DrgnBoatManager.instance.carStatus == _index)
         {
         ...
         {
            _currentBoat.visible = false;
            if(DrgnBoatManager.instance.carStatus > _index && _dressUpBtn)
            {
               _dressUpBtn.enable = false;
            }
         }
      ...
      private function initEvent() : void
      {
         ...
         DrgnBoatControl.instance.addEventListener("drgnBoatCarStatusChange",refreshView);
      }
      ...
      private function clickHandler(param1:MouseEvent) : void
      {
         ...
         var _loc2_:Object = DrgnBoatManager.instance.getBuyRecordStatus(0);
         ...
         var _loc3_:BaseAlerFrame = AlertManager.Instance.simpleAlert(LanguageMgr.GetTranslation("AlertDialog.Info"),LanguageMgr.GetTranslation("drgnBoat.frame.callCarConfirmTxt",_info.needMoney),LanguageMgr.GetTranslation("ok"),LanguageMgr.GetTranslation("cancel"),true,true,true,1,null,"DrgnBoatBuyConfirmView",30,true,0);
      ...
      private function callConfirm(param1:FrameEvent) : void
      {
         ...
         if(param1.responseCode == 3 || param1.responseCode == 2)
         {
            ...
            if((_loc4_ as DrgnBoatBuyConfirmView).isNoPrompt)
            {
               _loc3_ = DrgnBoatManager.instance.getBuyRecordStatus(0);
      ...
      private function removeEvent() : void
      {
         ...
         DrgnBoatControl.instance.removeEventListener("drgnBoatCarStatusChange",refreshView);
      }
