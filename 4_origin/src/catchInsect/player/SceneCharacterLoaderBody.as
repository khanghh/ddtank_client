package catchInsect.player
{
   ...
   public class SceneCharacterLoaderBody
   {
      ...
      {
         _loaders = new Vector.<CatchInsectSceneCharacterLayer>();
         _recordStyle = _playerInfo.Style.split(",");
         _recordColor = _playerInfo.Colors.split(",");
         _loaders.push(new CatchInsectSceneCharacterLayer(ItemManager.Instance.getTemplateById(int(_recordStyle[4].split("|")[0])),_recordColor[4],1,_playerInfo.Sex));
         _loaders.push(new CatchInsectSceneCharacterLayer(ItemManager.Instance.getTemplateById(int(_recordStyle[4].split("|")[0])),_recordColor[4],2,_playerInfo.Sex));
      }
