package gameStarling.actions
{
   ...
   public class SceneEffectShootBombAction extends BaseAction
   {
      ...
      public function SceneEffectShootBombAction(param1:int, param2:MapView3D, param3:Array, param4:CrazyTankSocketEvent, param5:int)
      {
         super();
         _livingId = param1;
         _map = param2;
      ...
      private function executeImp(param1:Boolean) : void
      {
         ...
         if(!_isShoot)
         {
            ...
            {
               _loc3_ = new SimpleBomb3D(_loc2_,null);
