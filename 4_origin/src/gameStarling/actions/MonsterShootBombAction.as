package gameStarling.actions
{
   ...
   public class MonsterShootBombAction extends BaseAction
   {
      ...
      public function MonsterShootBombAction(param1:GameLiving3D, param2:Array, param3:CrazyTankSocketEvent, param4:int)
      {
         super();
         _monster = param1;
         _bombs = param2;
      ...
      override public function prepare() : void
      {
         ...
         _monster.actionMovie.addEventListener(GameLiving3D.SHOOT_PREPARED,onEventPrepared);
      ...
      {
         _monster.actionMovie.removeEventListener(GameLiving3D.SHOOT_PREPARED,onEventPrepared);
         _prepared = true;
      ...
      private function executeImp(param1:Boolean) : void
      {
         ...
         if(!_isShoot)
         {
            ...
            {
               _loc3_ = new SimpleBomb3D(_loc2_,_monster.info);
