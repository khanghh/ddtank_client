package gameStarling.objects
{
   ...
   public class BombAction3D
   {
      ...
      public function execute(ball:SimpleBomb3D, _game:GameInfo) : void
      {
                           ...
                           if(7 !== _loc4_)
                           {
                                                         ...
                                                         if(18 !== _loc4_)
                                                         {
                                                            if(19 !== _loc4_)
                                                            {
                                                                     ...
                                                                     if(22 !== _loc4_)
                                                                     {
                                                                        if(23 !== _loc4_)
                                                                        {
                                                                           if(24 !== _loc4_)
                                                                           {
                                                                              if(25 !== _loc4_)
                                                                              {
                                                                                 if(26 !== _loc4_)
                                                                                 {
                                                                                    if(29 === _loc4_)
                                                                                    {
                                                                                       ...
                                                                                       var fallingDie2:PhysicalObj3D = ball.map.getPhysical(_param1);
                                                                                       if(fallingDie1 || fallingDie2 is GameLiving3D)
                                                                                       {
                                                                                 ...
                                                                                 else
                                                                                 {
                                                                                    ...
                                                                                    var fallingInfo2:PhysicalObj3D = ball.map.getPhysical(_param1);
                                                                                    if(fallingInfo1 || fallingInfo2 is GameLiving3D)
                                                                                    {
                                                                              ...
                                                                              {
                                                                                 var moveInfo1:PhysicalObj3D = ball.map.getPhysical(_param1);
                                                               ...
                                                               else
                                                               {
                                                                  ...
                                                                  if(player10 && RoomManager.Instance.current.type != 21)
                                                                  {
                              ...
                              else
                              {
                                 ...
                                 if(_param3 >= 0)
                                 {
                                    ...
                                    if(player6)
                                    {
                                       player6.showEffect("bonesGamePropanimationGuild");
                                    }
                                 }
                              }
                           }
         ...
         {
            var obj:PhysicalObj3D = ball.map.getPhysical(_param1);
            if(obj)
            {
