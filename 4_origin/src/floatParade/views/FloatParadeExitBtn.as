package floatParade.views
{
   ...
   public class FloatParadeExitBtn extends Sprite implements Disposeable
   {
      ...
      public function FloatParadeExitBtn()
      {
         super();
         this.x = 909;
         this.y = 513;
      ...
      {
         _bg = ComponentFactory.Instance.creatBitmap("floatParade.returnBtn.bg");
         _moveOutBtn = ComponentFactory.Instance.creatComponentByStylename("floatParade.moveOutBtn");
         _moveInBtn = ComponentFactory.Instance.creatComponentByStylename("floatParade.moveInBtn");
         _returnBtn = ComponentFactory.Instance.creatComponentByStylename("floatParade.returnBtn");
         addChild(_bg);
