package floatParade.views
{
   ...
   public class FloatParadeFrameItemCell extends Sprite implements Disposeable
   {
      ...
      public function FloatParadeFrameItemCell(index:int, info:FloatParadeCarInfo)
      {
         super();
         _index = index;
         _info = info;
      ...
      private function clickHandler(event:MouseEvent) : void
      {
         ...
         var tmpObj:Object = FloatParadeManager.instance.getBuyRecordStatus(0);
      ...
      private function callConfirm(evt:FrameEvent) : void
      {
         ...
         if(evt.responseCode == 3 || evt.responseCode == 2)
         {
            ...
            {
               tmpObj = FloatParadeManager.instance.getBuyRecordStatus(0);
