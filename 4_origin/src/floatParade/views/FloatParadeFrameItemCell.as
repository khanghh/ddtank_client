package floatParade.views
{
   ...
   public class FloatParadeFrameItemCell extends Sprite implements Disposeable
   {
      ...
      public function FloatParadeFrameItemCell(param1:int, param2:FloatParadeCarInfo)
      {
         super();
         _index = param1;
         _info = param2;
         ...
         initEvent();
         refreshView(null);
         if(_dressUpBtn && FloatParadeManager.instance.freeCount <= 0)
         {
      ...
      {
         _bg = ComponentFactory.Instance.creatBitmap("floatParade.cellBg" + _index);
         addChild(_bg);
         _awardBmp = ComponentFactory.Instance.creat("floatParade.award");
         addChild(_awardBmp);
         _currentBoat = ComponentFactory.Instance.creat("floatParade.currentBoat");
         addChild(_currentBoat);
         _currentBoat.visible = false;
         _awardInfoTxt1 = ComponentFactory.Instance.creatComponentByStylename("floatParade.race.awardTxt");
         ...
         _awardInfoTxt2 = ComponentFactory.Instance.creatComponentByStylename("floatParade.race.awardTxt");
         PositionUtils.setPos(_awardInfoTxt2,"floatParade.race.awardTxtPos");
         ...
         {
            case 0:
               _defaultTxt = ComponentFactory.Instance.creatComponentByStylename("floatParade.race.defaultTxt");
               _defaultTxt.text = LanguageMgr.GetTranslation("floatParade.race.noDress");
               addChild(_defaultTxt);
               break;
            case 1:
               _dressUpBtn = ComponentFactory.Instance.creatComponentByStylename("floatParade.race.dressUpTxtbtn");
      ...
      {
         if(FloatParadeManager.instance.carStatus == _index)
         {
         ...
         {
            _currentBoat.visible = false;
            if(FloatParadeManager.instance.carStatus > _index && _dressUpBtn)
            {
               _dressUpBtn.enable = false;
            }
         }
      ...
      private function initEvent() : void
      {
         ...
         FloatParadeManager.instance.addEventListener("floatParadeCarStatusChange",refreshView);
      }
      ...
      private function clickHandler(param1:MouseEvent) : void
      {
         ...
         var _loc2_:Object = FloatParadeManager.instance.getBuyRecordStatus(0);
         ...
         var _loc3_:BaseAlerFrame = AlertManager.Instance.simpleAlert(LanguageMgr.GetTranslation("AlertDialog.Info"),LanguageMgr.GetTranslation("floatParade.frame.callCarConfirmTxt",_info.needMoney),LanguageMgr.GetTranslation("ok"),LanguageMgr.GetTranslation("cancel"),true,true,true,1,null,"FloatParadeBuyConfirmView",30,true);
      ...
      private function callConfirm(param1:FrameEvent) : void
      {
         ...
         if(param1.responseCode == 3 || param1.responseCode == 2)
         {
            ...
            if((_loc4_ as FloatParadeBuyConfirmView).isNoPrompt)
            {
               _loc3_ = FloatParadeManager.instance.getBuyRecordStatus(0);
      ...
      private function removeEvent() : void
      {
         ...
         FloatParadeManager.instance.removeEventListener("floatParadeCarStatusChange",refreshView);
      }
