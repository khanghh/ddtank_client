package floatParade.views
{
   ...
   public class FloatParadeCountDown extends Sprite implements Disposeable
   {
      ...
      public function FloatParadeCountDown()
      {
         super();
         this.x = 260;
         initView();
      ...
      private function initView() : void
      {
         ...
         _recordTxt = LanguageMgr.GetTranslation("floatParade.frame.countDownViewTxt");
