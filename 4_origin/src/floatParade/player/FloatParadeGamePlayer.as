   ...
   public class FloatParadeGamePlayer extends Sprite implements Disposeable
   {
      ...
      public function FloatParadeGamePlayer(playerInfo:FloatParadePlayerInfo)
      {
         ...
         if(_playerInfo.carType == 3)
         {
            ...
            _carInfo.type = 3;
            _carInfo.speed = FloatParadeManager.instance.npcSpeed;
            this.y = 390;
         }
         else
         {
         ...
         _nameTxt.text = LanguageMgr.GetTranslation("floatParade.playerNameTxt" + _carInfo.type,_playerInfo.name);
         if(_carInfo.type == 3)
         {
         ...
         addChild(_nameTxt);
         _fightMc = ComponentFactory.Instance.creat("floatParade.playerFighting");
         _fightMc.gotoAndStop(2);
         PositionUtils.setPos(_fightMc,"floatParade.gamePlayer.fightMcPos");
         addChild(_fightMc);
         refreshFightMc();
         _leapArrow = ComponentFactory.Instance.creatBitmap("floatParade.leapPromptArrow");
         addChild(_leapArrow);
         ...
         if(_playerInfo.isSelf)
         {
            ...
            FloatParadeManager.instance.addEventListener("floatParadeLeapPromptShowHide",showOrHideLeapArrow);
         }
      }
      
      public function get playerInfo() : FloatParadePlayerInfo
      {
         return _playerInfo;
      }
      ...
      {
         FloatParadeManager.instance.removeEventListener("floatParadeLeapPromptShowHide",showOrHideLeapArrow);
         if(_playerMc)
         {
