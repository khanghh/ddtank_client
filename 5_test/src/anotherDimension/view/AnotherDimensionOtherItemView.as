...
public class AnotherDimensionOtherItemView extends Sprite implements Disposeable
{
    ...
    {
        ChatManager.Instance.sysChatYellow("__clickZhanling");
        ChatManager.Instance.sysChatYellow("pos: " + _anotherDimensionInfo.resourcePos.toString());
        ChatManager.Instance.sysChatYellow("isBoss: " + (_anotherDimensionInfo.monsterId == 0).toString());
        ChatManager.Instance.sysChatYellow("_anotherDimensionInfo.monsterId: " + _anotherDimensionInfo.monsterId.toString());
