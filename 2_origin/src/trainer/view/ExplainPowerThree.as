package trainer.view
{
   ...
   public class ExplainPowerThree extends BaseExplainFrame
   {
      ...
      private function initView() : void
      {
         ...
         addChild(_bmpPower);
         var posThree:Point = ComponentFactory.Instance.creatCustomObject("trainer.explain.posThreeBg");
         _bmpNameBgThree = ComponentFactory.Instance.creatBitmap("asset.explain.nameBgSmall");
         _bmpNameBgThree.x = posThree.x;
         _bmpNameBgThree.y = posThree.y;
         addChild(_bmpNameBgThree);
         var posPower:Point = ComponentFactory.Instance.creatCustomObject("trainer.explain.posPowerBg");
         _bmpNameBgPower = ComponentFactory.Instance.creatBitmap("asset.explain.nameBgSmall");
         _bmpNameBgPower.x = posPower.x;
         _bmpNameBgPower.y = posPower.y;
