package starlingui.core.components
{
   ...
   public class PixelButton extends DisplayObjectContainer
   {
      ...
      public function PixelButton(param1:Texture, param2:String = "", param3:Texture = null, param4:Texture = null, param5:Texture = null, param6:BitmapData = null)
      {
         super();
         if(param1 == null)
         {
         ...
         mState = "up";
         mBody = new PixelImage(param1,param6);
      ...
      private function onTouch(param1:TouchEvent) : void
      {
         ...
         else if(_loc2_.phase == "ended" && mState == "down")
         {
            ...
            if(!_loc2_.cancelled)
            {
               dispatchEventWith("triggered",true,_loc2_);
            }
         }
      }
