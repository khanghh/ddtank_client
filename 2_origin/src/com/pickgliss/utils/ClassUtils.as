package com.pickgliss.utils
{
   ...
   public final class ClassUtils
   {
      ...
      public static function classIsBitmapData(param1:String) : Boolean
      {
         ...
         var _loc3_:* = getDefinitionByName(param1);
         var _loc2_:String = getQualifiedSuperclassName(_loc3_);
         return _loc2_ == "flash.display::BitmapData";
      }
      
      public static function classIsComponent(param1:String) : Boolean
      {
         if(param1 == "com.pickgliss.ui.text.FilterFrameText" || param1 == "com.pickgliss.ui.controls.SimpleDropListTarget" || param1 == "ddt.view.FriendDropListTarget" || param1 == "com.pickgliss.ui.FilterFrameTextWithTips" || param1 == "eliteGame.view.EliteGamePaarungText")
         {
            return false;
         }
         return true;
