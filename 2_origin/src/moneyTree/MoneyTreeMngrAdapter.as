package moneyTree
{
   ...
   public class MoneyTreeMngrAdapter extends MoneyTreeManager
   {
      ...
      override public function getCurSpeedUpToMature() : String
      {
         return "";
      }
      
      override public function getCurSpeedUpOnce() : String
      {
         return "";
      }
      ...
      override public function onSpeedUpTypeSelected() : int
      {
         return 0;
      }
      ...
      override public function get positon() : int
      {
         return 0;
      }
      ...
      override public function get isShowNPC() : Boolean
      {
         return false;
      }
   }
