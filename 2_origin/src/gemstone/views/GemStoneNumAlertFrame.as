package gemstone.views
{
   ...
   public class GemStoneNumAlertFrame extends BaseAlerFrame
   {
      ...
      private function initView() : void
      {
         ...
         _alertInfo = new AlertInfo(LanguageMgr.GetTranslation("ddt.gemstone.alertFrame.title"),LanguageMgr.GetTranslation("ok"),"",true,false);
         ...
         maxLimit = bagInfo.getItemCountByTemplateId(100100);
         _cell.setCount(maxLimit);
         addToContent(_cell);
         _descript = ComponentFactory.Instance.creatComponentByStylename("gemstone.alertFrame.descriptTxt");
         _descript.text = LanguageMgr.GetTranslation("ddt.gemstone.alertFrame.descript");
