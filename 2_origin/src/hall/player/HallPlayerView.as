package hall.player
{
   ...
   public class HallPlayerView extends Sprite
   {
      ...
      public function HallPlayerView(bg:Sprite)
      {
         super();
         _bg = bg;
