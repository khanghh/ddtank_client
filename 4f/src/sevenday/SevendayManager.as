package sevenday
{
   ...
   public class SevendayManager extends EventDispatcher
   {
      ...
      public function SevendayManager(param1:inner){super(null);}
      ...
      public function isNotAllAchieved(param1:int = 0) : Boolean{return false;}
      ...
      public function getQuestComplete() : Boolean{return false;}
