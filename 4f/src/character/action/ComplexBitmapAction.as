package character.action{   public class ComplexBitmapAction extends BaseAction   {                   private var _assets:Vector.<FrameByFrameItem>;            private var _index:int;            public function ComplexBitmapAction(assets:Vector.<FrameByFrameItem>, name:String = "", nextAction:String = "", priority:uint = 0, endStop:Boolean = false) { super(null,null,null,null); }
