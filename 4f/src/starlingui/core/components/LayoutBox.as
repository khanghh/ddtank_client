package starlingui.core.components
{
   ...
   public class LayoutBox extends Box
   {
      ...
      override public function removeChild(param1:DisplayObject, param2:Boolean = false) : DisplayObject{return null;}
      
      override public function removeChildAt(param1:int, param2:Boolean = false) : DisplayObject{return null;}
