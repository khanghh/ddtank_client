package store.view.transfer
{
   ...
   public class StoreIITransferBG extends Sprite implements IStoreViewBG
   {
      ...
      private function isComposeStrengthen(param1:BagCell) : Boolean{return false;}
      ...
      private function isHasBead(param1:BagCell) : Boolean{return false;}
      
      private function isOpenHole(param1:BagCell) : Boolean{return false;}
