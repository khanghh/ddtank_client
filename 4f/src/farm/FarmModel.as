package farm
{
   ...
   public class FarmModel extends EventDispatcher
   {
      ...
      public function FarmModel(param1:IEventDispatcher = null){super(null);}
      ...
      public function getfieldInfoById(param1:int) : FieldVO{return null;}
      ...
      public function findItemInfo(param1:int, param2:int) : InventoryItemInfo{return null;}
      
      public function getSeedCountByID(param1:int) : int{return 0;}
