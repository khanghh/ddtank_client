package ddt.data.quest
{
   ...
   public class QuestInfo implements INotSameHeightListCellData
   {
      ...
      public static function createFromXML(param1:XML) : QuestInfo{return null;}
      ...
      public function isAvailableFor(param1:SelfInfo) : Boolean{return false;}
      
      public function get isAvailable() : Boolean{return false;}
      
      public function get isAchieved() : Boolean{return false;}
      
      private function getProgressById(param1:uint) : uint{return null;}
      ...
      private function getConditionById(param1:uint) : QuestCondition{return null;}
      
      private function getIsAutoComplete(param1:int) : Boolean{return false;}
