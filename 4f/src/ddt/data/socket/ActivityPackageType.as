package ddt.data.socket
{
   public class ActivityPackageType
   {
      ...
      public static const ONLINE_REWARD_INFO:int = 1;
      
      public static const ONLINE_REWARD_GET:int = 2;
      
      public static const ONLINE_REWARD_BOX_CONFIG:int = 3;
      
      public static const ONLINE_REWARD_OPEN_CLOSE:int = 4;
       
      
      public function ActivityPackageType(){super();}
   }
}
