package starling.utils
{
   ...
   public class Color
   {
      ...
      public function Color(){super();}
      
      public static function getAlpha(param1:uint) : int{return 0;}
      
      public static function getRed(param1:uint) : int{return 0;}
      
      public static function getGreen(param1:uint) : int{return 0;}
      
      public static function getBlue(param1:uint) : int{return 0;}
      
      public static function rgb(param1:int, param2:int, param3:int) : uint{return null;}
      
      public static function argb(param1:int, param2:int, param3:int, param4:int) : uint{return null;}
   }
}
