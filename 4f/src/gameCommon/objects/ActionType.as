package gameCommon.objects
{
   public class ActionType
   {
      ...
      public static const ACTION_TYPES:Array = ["stand","angry","shield","cryB","standB","standC","standD"];
      ...
      public static const BOMB_DIE:int = 21;
      
      public static const BALL_SPRING:int = 22;
      
      public static const BALL_XYANDVXVY:int = 23;
      
      public static const BALL_GROUNDPOS:int = 24;
      
      public static const PLAYER_START_MOVE:int = 25;
      
      public static const PLAYER_START_FALLING:int = 26;
      
      public static const BALL_SPIDERPOS:int = 27;
      
      public static const FALLING_DIE:int = 29;
       
      
      public function ActionType(){super();}
   }
}
