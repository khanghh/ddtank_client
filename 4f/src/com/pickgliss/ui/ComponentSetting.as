package com.pickgliss.ui
{
   ...
   public final class ComponentSetting
   {
      ...
      public static var USERSL:String = "";
      ...
      public static var md5Dic:Object = {};
      
      public static var swf_head:String = "road7";
       
      
      public function ComponentSetting(){super();}
      
      public static function getUIConfigXMLPath(param1:String) : String{return null;}
      
      public static function getUIConfigZIPPath() : String{return null;}
      
      public static function getUISourcePath(param1:String) : String{return null;}
   }
}
