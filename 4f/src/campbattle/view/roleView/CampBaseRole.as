package campbattle.view.roleView
{
   ...
   public class CampBaseRole extends SceneCharacterPlayerBase
   {
      ...
      public function CampBaseRole(param1:RoleData, param2:Function = null){super(null);}
      ...
      private function callBackSetInfo(param1:LoaderHeadOrBody, param2:Boolean) : Boolean{return false;}
