package newChickenBox.model
{
   ...
   public class NewChickenBoxModel extends EventDispatcher
   {
      ...
      public function NewChickenBoxModel(){super();}
      
      public static function get instance() : NewChickenBoxModel{return null;}
      
      public function get canclickEnable() : Boolean{return false;}
      
      public function set canclickEnable(param1:Boolean) : void{}
      
      public function get templateIDList() : Array{return null;}
