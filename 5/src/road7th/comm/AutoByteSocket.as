package road7th.comm
{
	...
	public class AutoByteSocket extends EventDispatcher
	{
		...
		public function AutoByteSocket(param1:Boolean = true, param2:Boolean = false)
		{
		...
		private function handleIoError(param1:ErrorEvent) : void
		{
			try
			{
				ChatManager.Instance.sysChatYellow(param1.text);
