package gameCommon.view.smallMap
{
    ...
    public class SmallMapView extends Sprite implements Disposeable
    {
        ...
        public function toggleShowThreeKill(val:Boolean):void
        {
            _isShowThreeKill = val;
        }
    }
}
