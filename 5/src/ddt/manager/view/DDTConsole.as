...
public class DDTConsole extends Sprite
{
    ...
    {
        main = this;	// Start off point for seeing/using variables and functions (main class or frame/stage)
        ...
        historyText.width = stage.stageWidth;
        ...
        // Tracer
        tracerAlignX = stage.stageWidth - 5;
        tracerAlignY = 5;
    ...
    public function setTarget(_main:*):void
    {
        main = _main;
    }
    ...
    private function showSuggestions(str:String):void
    {
        ...
        var symbols:Array = null;
        symbols = fillArrayWithIndexsOf(symbols,str,["(","=",",","-","+","/","*","%",":","["]);
        ...
        if (str != "")
        {
            try
            {
                ...
                if (areSuggestions)
                {
                    ...
                    if (consoleHeight == stage.stageHeight)
    ...
    {
        if (consoleHeight != stage.stageHeight)
            consoleHeight = stage.stageHeight; // Extend
        else
        ...
        if (slideAnimation)
        {
            addEventListener(Event.ENTER_FRAME, fullscreenSlide);
            slideAnimation_animating = true;
    ...
    private function stopFullscreenSlideAnimation():void
    {
        ...
        removeEventListener(Event.ENTER_FRAME, fullscreenSlide);
        slideAnimation_animating = false;
    }
